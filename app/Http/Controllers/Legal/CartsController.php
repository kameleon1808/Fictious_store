...
class CartsController extends Controller
{
    ...
    public function totalPrice()
    {
        $user = Auth::user();
        $sum_prices = 0;
        $sum_prices = Cart::where('legal_id', $user->id)->sum('price');
        return $sum_prices;
    }
    ...
    public function show(Request $request)
    {
        ...
        $data = Cart::where('legal_id', $user->id)->get();

        $sum_art = Cart::where('legal_id', $user->id)->sum('prod_qty');
